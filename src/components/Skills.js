...
const Skills = () => {
  return (
    <>
    <h2 className='font-bold text-8xl mt-32 w-full text-center md:text-6xl xs:text-4xl md:mb-16'>Skills</h2>
    ...
    '>
        ...
        <Skill name='CSS' x='-10vw' y='-15vw'/>
        <Skill name='Javascript' x='20vw' y='6vw'/>
        <Skill name='ReactJS' x='0vw' y='12vw'/>
        <Skill name='NextJS' x='-25vw' y='-20vw'/>
        <Skill name='Typescript' x='15vw' y='-12vw'/>
        <Skill name='Tailwind CSS' x='35vw' y='-5vw'/>
        <Skill name='Java' x='0vw' y='-21vw'/>
        <Skill name='Salesforce' x='-28vw' y='-5vw'/>
        <Skill name='Technical Writing' x='0vw' y='21vw'/>
